/**
 * ListingHub Blog Page — composed from ported theme components.
 * Mirrors: ListingHub/ListingHub_NextJs (Javascript)/src/app/blog/page.jsx
 */
...
import { blogData } from '@/lib/theme-data'
              ...
              <div className="card rounded-4 border">
                <div className="row align-items-center justify-content-start">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <Link href="/blog" className="d-block p-3">
                  ...
                  <div className="col-xl-8 col-lg-8 col-md-8">
                    <div className="card-body">
                      ...
                      <Link href="/blog"><h4 className="fw-semibold fs-5 lh-base mb-2">Boost Your Website&apos;s Performance with These Bootstrap Optimization Tips</h4></Link>
                      <p>Cicero famously orated against his political opponent Lucius Sergius Catilina. Occasionally the first Oration against Catiline is taken for type specimens.</p>
                      <div className="d-flex align-items-center justify-content-start mt-4">
                        <Link href="/blog" className="badge badge-primary rounded-pill">Continue Reading</Link>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {blogData.map((item, index) => (
              <div className="col-xl-4 col-lg-4 col-md-6" key={index}>
                <div className="card rounded-4 shadow-sm h-100">
                  <Link href={`/blog`} className="d-block bg-gradient rounded-top">
                  ...
                  <div className="card-body">
                    <Link href={`/blog`}><h4 className="fw-semibold fs-5 lh-base mb-3">{item.title}</h4></Link>
                    <p>{item.desc}</p>
                    <div className="d-flex align-items-center justify-content-start mt-4">
                      <Link href={`/blog`} className="badge badge-primary rounded-pill">Continue Reading</Link>
                    </div>
