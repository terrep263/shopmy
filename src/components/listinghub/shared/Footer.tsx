...
const footerLink1 = ['Community', 'Groups', 'Events', 'Advertising']
const footerLink2 = ['Sign Up', 'Find Properties', 'FAQ', 'Help']
const footerLink3 = ['For Business', 'For Agents', 'For Investors', 'Pricing']
        ...
        <div className="row">
          <div className="col-12 col-md-5 col-lg-12 col-xl-4">
            <div className="footer-widget pe-xl-4 mb-5">
              <div className="footerLogo"><Image src='/img/logo-light.svg' width={160} height={0} alt="Footer Logo" className="img-fluid" /></div>
