...
import { reviewData } from '@/lib/theme-data'
...
interface ClientOneProps {
  reviews?: ReviewDataItem[];
}

export default function ClientOne({ reviews }: ClientOneProps) {
        ...
        <div className="row align-items-center justify-content-center">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                 <Swiper
                        ...
                        >
                    {data.map((item: ReviewDataItem,index:number)=>{
                        return(
