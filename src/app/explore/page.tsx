...
/**
 * ListingHub theme home - explore listings, categories, and content.
 * Uses theme-data for demo; replace with your API/deals data for production.
 */
            ...
            <div className="col-xl-12 col-lg-12 col-md-12 col-md-12 col-12">
              <div className="popularSearches d-flex align-items-center justify-content-center column-gap-3 row-gap-1 flex-wrap">
                <div className="singleItem">
                  <Link href="/deals" className="badge badge-transparent rounded-pill">
                    Deals
                  </Link>
                </div>
                <div className="singleItem">
                  <Link href="/business" className="badge badge-transparent rounded-pill">
                    Business
                  </Link>
                </div>
                <div className="singleItem">
                  <Link href="/explore" className="badge badge-transparent rounded-pill">
                    Shopping
                  </Link>
                </div>
                <div className="singleItem">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-xl-7 col-lg-8 col-md-11 col-sm-12">
              <div className="secHeading-wrap text-center">
                ...
                <p>Join and get latest & trending updates about listing</p>
              </div>
            </div>
          </div>
          <BlogOne />
